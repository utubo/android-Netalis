...
public class Task implements Cloneable {
    ...
    public String task = "";
    public int status = TaskStatus.TODO.intValue;
    ...
    private String toJSON() {
        ...
        sb.append("\tstatus:"    ).append(U.ezJsonStr(TaskStatus.valueOf(status).name())).append(",\n");
    ...
    public static List<Task> fromJSON(String s) {
        ...
        try {
            ...
            for (int i = 0; i < ary.length(); i ++) {
                ...
                task.status = TaskStatus.valueOf(jTask.getString("status")).intValue;
